...
if (isset($_POST['submit'])) {
    ...
    $insert = "INSERT INTO `course`(`c_id`, `name`, `course_code`, `credit_hours`, `clos`, `reference_books`, `outline`, `theory_wb`, `lab_wb`, `objectives`, `a_id`) VALUES ('[value-1]','$name','$course_code','$credit_hours','$clos','$reference_books','$outline','$theory_wb','$lab_wb','$objectives','[value-11]')";
        ...
        <div class="container">
            <div class="row h-100 justify-content-center align-items-center">
                <div class="col-10 col-md-6 col-lg-6" style="background-color: lightgray; border: 1px solid black;">
                    <center>
                        <h3 style="padding: 10px">Add New Course</h3>
                    </center>
                    ...
                    <form method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="clos">
                        </div>
                        <div class="form-group">
                            <label for="reference_books">Reference Books</label>
                            <input type="text" class="form-control" name="reference_books">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="theory_wb">
                        </div>
                        <div class="form-group">
                            <label for="lab_wb">Lab Weekly Breakup</label>
                            <input type="text" class="form-control" name="lab_wb">
                        </div>
                        <div class="form-group">
