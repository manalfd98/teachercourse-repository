...
<body>
    ...
    <div class="container">
        <div class="">
            <h2 style="margin-top: 20px">BSCS Courses</h2>
            <button class="btn btn-dark" style="margin-left: 90%;"><a href="add_course.php" class="text-light">Add Course</button></a>
        </div>
        <table class="table table-bordered">
            <thead>
                <tr>
                    ...
                    <th scope="col">WB-Theory</th>
                    <th scope="col">WB-Lab</th>
                ...
                if ($num > 0) {
                    while ($result = mysqli_fetch_assoc($select)) {
                        ...
                        <tr>
                            ...
                            <td>" . $result['clos'] . "</td>
                            <td>" . $result['reference_books'] . "</td>
                            <td>" . $result['outline'] . "</td>
                            <td>" . $result['theory_wb'] . "</td>
                            <td>" . $result['lab_wb'] . "</td>
                            <td>" . $result['objectives'] . "</td>
                            
                            <td><a href='web_course.php' class='btn btn-primary'>View</a></td>

                            
                            <td><a href='deletecourse.php?c_id=$result[c_id] class='btn btn-danger''><input type='submit'
                            value='Delete' class='btn btn-danger'></a></td>

                            <td><a href='updatecourse.php?c_id=$result[c_id] class='btn btn-success''><input type='submit'
